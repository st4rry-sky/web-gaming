      ...
      <div className="hero">
        <div className="container">
          <h1 className="hero__heading">
            ...
            <span className="hero__name">temanchib</span>
          </h1>
          ...
          <div className="hero__info">
            ...
            <Button btnText="see my history gaming" btnLink="/live-streaming" />
          </div>
          <div className="hero__social">
            ...
            <div className="hero__social__text">
              <ul>
                <li>
                  <a
                    href="https://www.facebook.com/Temanchib-Gaming-107531188218311"
                    target="_blank"
                    rel="noreferrer"
                  >
                    FB
