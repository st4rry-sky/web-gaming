# temachib gaming website [React Project]
...
This is a beginner-friendly react js project. This project is made for education purposes by the Team. We are going to learn so many things through this project especially how to work with React Js. React Js is one of the hottest techs for web dev. Through this project, we will have a good understanding of react js. Besides React js we are going to use many other techs. Also, there will be a full project tutorial playlist on so that you can get the step-by-step guide to make this portfolio.
...
The recommended way to get started with the project is Follow the. You will find all the step-by-step guides for free. Or you Can start the project on your own by following the guide below.
